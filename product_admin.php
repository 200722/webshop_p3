...
?>
            <a  href="productdetails.php?id= <?php echo $product_id ?>"><button  class="btn btn-success font-size-12">details</button>
            
            <a href="product_update.php?id= <?php echo $product_id ?>"><button  class="btn btn-success font-size-12">update</button>
            <a href="deleteProduct.php?id=  <?php echo $product_id ?>"><button  class="btn btn-success font-size-12">Delete</button>

            <br>  <br>  <br>

               <div>
               <a href="cart.php?id= <?php echo $product_id ?>"> <button type="submit" class="btn btn-warning font-size-12">Add to Cart</button>
