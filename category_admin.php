...
// $sql = "SELECT `category_id`, `name`, `description`, `active` FROM `category`";
...
?>
            ...
            <a  href="categorydetails.php?id= <?php echo $category_id ?>"><button class="btn btn-success font-size-12">details</button>
            
            <a href="category_update.php?id= <?php echo $category_id ?>"><button class="btn btn-success font-size-12">update</button>
            <a href="categorydelete.php?id=  <?php echo $category_id ?>"><button  class="btn btn-success font-size-12">Delete</button>
